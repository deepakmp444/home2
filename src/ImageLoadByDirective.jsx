...
const ImageLoadByDirective = () => {
  ...
  const currentImage =
    currentFolder.images?.[currentImageIndex] || "No image available";
  const imageName = currentImage.split("/").pop() || "No image available";
  return (
    <Container className="text-center mt-5">
      <h6>Folder Name: {currentFolder.name}</h6>
      {loading ? (
